...
# Filename:-
logging.basicConfig(filename="F:\Restful-API's\RestAPI\log files\est.log", level=logging.error('Raghu raising a warning...'),  filemode='a') # W override, a append, default value is append
...
# filename='D:\\log.txt'
# F:\Restful-API's\RestAPI\log files
