...
# blueprint setup
patient_personal = Blueprint("patient_personal", __name__)

patient_personal.config['MYSQL_HOST'] = 'localhost'
patient_personal.config['MYSQL_USER'] = 'root'
patient_personal.config['MYSQL_PASSWORD'] = ''
patient_personal.config['MYSQL_DB'] = 'clinicalfirst'

mysql = MySQL(patient_personal)

# patient_personal:-
# create in postman by using jsonify:-
@patient_personal.route('/create', methods=['POST'])
...
http://127.0.0.1:5000/personal/create 
Body---> Raw----> json
{
    "patient_id"        :  1,
    "patient_name"      :  "Raghu",
