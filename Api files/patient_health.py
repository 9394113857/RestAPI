...
patient_health.config['MYSQL_HOST'] = 'localhost'
patient_health.config['MYSQL_USER'] = 'root'
patient_health.config['MYSQL_PASSWORD'] = ''
patient_health.config['MYSQL_DB'] = 'clinicalfirst'

mysql = MySQL(patient_health)

# patient_health:-
# create in postman by using jsonify:-
@patient_health.route('/create', methods=['POST'])
def patient_health():
...
http://127.0.0.1:5000/health/create 
Body---> Raw----> json
{
    "health_id"             :   1,
    "patient_id"            :   1,
