...
logging.basicConfig(filename="F:\Restful-API's\RestAPI\log files\Tests.log",
...
# Test messages
logger.info('-----------------------------')
logger.info("User_Tests script started Now:-")
"""
    ...
    if 'session_id' in request.json and 'test_id' in request.json \
        ...
        # Checking conditions:-
            ...
            cursor.execute(
                ...
                (session_id, user_id, test_id, test_name, disease_name, IPAddress, hostname))
