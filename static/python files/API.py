...
# Enter your databasee connection details below
...
def USER_SIGNUP():
    if request.method == 'POST':
        try:
            ...
            cur.execute(
                'INSERT INTO USER_SIGNUP(USER_SIGNUP_ID,USER_ID,USER_NAME,USER_MAIL_ID,USER_PHONE_NUMBER,USER_PASSWORD,USER_IP) VALUES(%s,%s,%s,%s,%s,%s,%s)',
